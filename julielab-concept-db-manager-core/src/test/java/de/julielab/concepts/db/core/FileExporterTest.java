...
public class FileExporterTest {
	...
	public static void main(String[] args) throws Exception {
		...
		FileBasedConfigurationBuilder<XMLConfiguration> confbuilder = new FileBasedConfigurationBuilder<>(XMLConfiguration.class).configure(params.xml().setFileName("src/test/resources/fileexporterconfig.xml"));
