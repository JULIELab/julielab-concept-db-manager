...
public interface DatabaseOperator extends ExtensionPoint, DatabaseConnected, ParameterExposing {
    void operate(HierarchicalConfiguration<ImmutableNode> operationConfiguration) throws DatabaseOperationException, IncompatibleActionHandlerConnectionException;
