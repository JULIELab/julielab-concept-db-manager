...
public class CLIParameters {
    ...
    @Option(name = "-p", aliases = {"--preparation"}, handler = OptionalStringArrayOptionHandler.class, usage = "Performs preparative operations like index creation. The names of preparatory operations can optionally be given as whitespace separated arguments. Only these operations will be called.", metaVar = "[preparatory operation names]")
